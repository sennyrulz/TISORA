      ...
      <div className="card shadow-lg" style={{ maxWidth: '600px', width: '100%' }}>
        <div className="card-body text-center p-5">
                  ...
                  <div className="p-4 border rounded">
                    ...
                    <div className="mb-4">
                      <div className="d-flex align-items-center mb-3">
                        <FaShoppingBag style={{ color: '#91443f' }} className="me-2" />
                        <p className="text-muted mb-0">Purchased Item</p>
                      </div>
                      {paymentData.order?.items?.map((item, index) => (
                        <div key={index} className="d-flex justify-content-between align-items-start mb-3">
                          ...
                          <div className="text-end">
                            ...
                            <p className="mb-0 fw-medium">Quantity: {item.quantity}</p>
                          </div>
                        </div>
          ...
          <div className="mt-4 text-center">
            ...
            <Link to="/orders" className="btn rounded-0 py-2"
                style={{ 
                  borderColor: '#91443f', 
                  color: '#91443f',
